...
def main_gh_simple(points, dict_nodes, r, sup_nodes=None, sup_bars=None, l_bars=None, load=None, check_col=False, correct=False):
    ...
    xfunc(points, dict_nodes, r, support_nodes=sup_nodes,
